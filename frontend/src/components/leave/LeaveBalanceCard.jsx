...
const LeaveBalanceCard = ({ totalAnnualLeave = 0, usedAnnualLeave = 0, remainingAnnualLeave = 0 }) => {
    ...
    // 1. 실제 잔여 연차 (승인된 것만 차감) 
    const actualRemaining = totalAnnualLeave - usedAnnualLeave;
    // 사용률 계산
        ...
        <div style={styles.container}>
            <div style={styles.infoWrapper}>
                <div>
                    ...
                    <h2 style={styles.count}>{actualRemaining} <span style={{fontSize: '20px'}}>일</span></h2>
                    <p style={styles.subText}>
                        신청 가능 {remainingAnnualLeave}일 | 승인 {usedAnnualLeave}일
                    </p>
                </div>
                <div style={{...styles.availableBadge, textAlign: 'right'}}>
...
const styles = {
    ...
    availableBadge: {
        backgroundColor: 'rgba(255, 255, 255, 0.15)', // 살짝 투명한 흰색 박스
    ...
    label: { fontSize: '16px', opacity: 0.8 },
