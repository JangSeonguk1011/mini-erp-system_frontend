          ...
          <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-xs text-gray-500 truncate">
                {user?.departmentName || '개발팀'} · {user?.position || '대리'}
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm mb-8">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-bold text-gray-800">이번 주 일정</h3>
          <span className="text-xs text-gray-400 ml-2">3월 30일 ~ 4월 3일</span>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <ScheduleItem date="03/24 (월)" title="대시보드 UI 개발" color="blue" />
        <ScheduleItem date="03/25 (화)" title="스프린트 회의" color="purple" />
        <ScheduleItem date="03/26 (수)" title="테스트 코드 작성" color="green" />
        <ScheduleItem date="03/27 (목)" title="연차 (오후)" color="orange" isLeave />
        <ScheduleItem date="03/28 (금)" title="주간 리뷰" color="gray" />
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <div className="space-y-3">
          <TodoItem title="로그인 API 구현" project="그룹웨어 개발" status="완료" dDay="완료" />
          <TodoItem title="사용자 대시보드 UI 개발" project="그룹웨어 개발" status="진행중" dDay="D-2" active />
          <TodoItem title="연차 결제 로직 검토" project="그룹웨어 개발" status="대기" dDay="D-5" />
          <TodoItem title="단위 테스트 코드 작성" project="그룹웨어 개발" status="대기" dDay="D-7" />
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
        ...
        <div className="space-y-6">
          <ProgressItem title="사내 그룹웨어 개발" percent={65} color="bg-blue-500" status="진행중" />
          <ProgressItem title="ERP 시스템 고도화" percent={30} color="bg-emerald-500" status="검토중" />
          <ProgressItem title="모바일 앱 리뉴얼" percent={10} color="bg-purple-500" status="기획중" />
        </div>
